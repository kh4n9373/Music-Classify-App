...
def analyze_audio(audio_file):
    ...
    while start + 30*sr < len(y):
        scaler = joblib.load('/home/khangpt/music_classification_app/saved_model/scaler.pkl')
...
def predict_(aud):
    ...
    with open('/home/khangpt/music_classification_app/saved_model/ens_model.pkl', 'rb') as file:
        ens_model = pickle.load(file)
    with open('/home/khangpt/music_classification_app/saved_model/knn_model.pkl', 'rb') as file:
        knn_model = pickle.load(file)
    with open('/home/khangpt/music_classification_app/saved_model/svm_model.pkl', 'rb') as file:
        svm_model = pickle.load(file)
    nn_model = load_model('/home/khangpt/music_classification_app/saved_model/nn_model.keras')  # Assuming load_model loads the neural network
...
app.config['UPLOAD_FOLDER'] = '/home/khangpt/music_classification_app/user_song'
